...
const char D_INTRO_0[] PROGMEM = "WiFi Warper";
const char D_INTRO_1[] PROGMEM = "by HNTech";
const char D_INTRO_2[] PROGMEM = DISPLAY_TEXT;
const char D_RESETTING[] PROGMEM = "Resetting...";
const char D_SCANNING_0[] PROGMEM = "CYAN.AI loaded";
const char D_SCANNING_1[] PROGMEM = "> Ready...";
const char D_SCANNING_2[] PROGMEM = "> Set...";
const char D_SCANNING_3[] PROGMEM = "> Go!";
